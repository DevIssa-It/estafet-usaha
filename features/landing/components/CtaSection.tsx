    ...
    <section style={{ padding: "88px 0", backgroundColor: "var(--color-surface-soft)" }}>
      <div className="container-content">
        <motion.div
          ...
          style={{ padding: "64px 32px", position: "relative", overflow: "hidden", background: "linear-gradient(135deg, #4f46e5 0%, #4338ca 100%)", borderRadius: 24, boxShadow: "0 12px 32px rgba(79, 70, 229, 0.25)" }}
        >
