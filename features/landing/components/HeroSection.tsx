    ...
    <section style={{ paddingTop: 140, paddingBottom: 80, position: "relative", overflow: "hidden", backgroundColor: "#f8fafc" }}>
      ...
      <div className="container-content text-center" style={{ position: "relative", zIndex: 1 }}>
        ...
        <motion.div
          ...
          style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 16px", borderRadius: 9999, backgroundColor: "#e0e7ff", border: "1px solid #c7d2fe", marginBottom: 24 }}
        >
        ...
        <motion.h1
          ...
          style={{ color: "#0f172a", marginBottom: 20, maxWidth: 840, margin: "0 auto 20px", fontWeight: 700, lineHeight: 1.15 }}
        >
        ...
        <motion.p
          ...
          className="body-lg"
          style={{ maxWidth: 620, margin: "0 auto 36px", color: "#475569", fontSize: 18, lineHeight: 1.6 }}
        >
        ...
        <motion.div
          ...
          style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 28, marginTop: 44, color: "#64748b", fontSize: 14, flexWrap: "wrap" }}
        >
